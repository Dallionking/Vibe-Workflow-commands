...
export class SystemIntegrationEngine {
    ...
    private async gatherPrpContextData(request: ContextRequest): Promise<any> { return {}; }
    private async gatherFieldProtocolContextData(request: ContextRequest): Promise<any> { return {}; }
