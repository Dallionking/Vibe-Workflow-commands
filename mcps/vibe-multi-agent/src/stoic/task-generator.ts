...
export class TaskGenerator {
  ...
  async generateTasks(architecture: any, options: TaskGenerationOptions): Promise<any[]> {
  ...
  private generateFoundationTasks(architecture: any, options: TaskGenerationOptions): any[] {
    const tasks = [
      {
        id: generateId(),
  ...
  private generateComponentTasks(component: any, architecture: any, options: TaskGenerationOptions): any[] {
    const tasks: any[] = [];
  ...
  private generateAuthTasks(component: any, options: TaskGenerationOptions): any[] {
    return [
      {
        id: generateId(),
  ...
  private generateUserTasks(component: any, options: TaskGenerationOptions): any[] {
    return [
      {
        id: generateId(),
  ...
  private generateApiTasks(component: any, options: TaskGenerationOptions): any[] {
    return [
      {
        id: generateId(),
  ...
  private generateFrontendTasks(component: any, architecture: any, options: TaskGenerationOptions): any[] {
    const tasks = [
      {
        id: generateId(),
  ...
  private generateDatabaseTasks(component: any, options: TaskGenerationOptions): any[] {
    return [
      {
        id: generateId(),
  ...
  private generateBillingTasks(component: any, options: TaskGenerationOptions): any[] {
    return [
      {
        id: generateId(),
  ...
  private generateAnalyticsTasks(component: any, options: TaskGenerationOptions): any[] {
    return [
      {
        id: generateId(),
  ...
  private generateGenericComponentTasks(component: any, options: TaskGenerationOptions): any[] {
    return [
      {
        id: generateId(),
  ...
  private generateTestingTasks(architecture: any, options: TaskGenerationOptions): any[] {
    return [
      {
        id: generateId(),
  ...
  private generateDocumentationTasks(architecture: any, options: TaskGenerationOptions): any[] {
    return [
      {
        id: generateId(),
  ...
  private generateDeploymentTasks(architecture: any, options: TaskGenerationOptions): any[] {
    return [
      {
        id: generateId(),
  ...
  private addTaskDependencies(tasks: any[]): void {
  ...
  private setPriorities(tasks: any[]): void {
