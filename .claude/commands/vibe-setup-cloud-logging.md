---
description: Set up integration with cloud logging services (AWS, GCP, Azure, etc.)
allowed-tools:
...
Set up integration with cloud logging services (AWS, GCP, Azure, etc.)

## Usage
`/vibe-setup-cloud-logging [--provider] [--log-group] [--retention-days]`
