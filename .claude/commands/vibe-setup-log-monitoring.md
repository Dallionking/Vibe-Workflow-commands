---
description: Create log monitoring scripts and alerting for error detection
allowed-tools:
...
Create log monitoring scripts and alerting for error detection

## Usage
`/vibe-setup-log-monitoring [--error-threshold] [--alert-email]`
