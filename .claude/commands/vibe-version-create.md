---
description: Create new project version with semantic versioning
allowed-tools:
...
Create new project version with semantic versioning

## Usage
`/vibe-version-create <version-type> <description> [--auto-detect] [--force]`
