---
description: Configure structured logging, log rotation, and log management for your project
allowed-tools:
...
Configure structured logging, log rotation, and log management for your project

## Usage
`/vibe-setup-logging [--cloud-provider] [--log-level]`
