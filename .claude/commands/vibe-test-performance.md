---
description: Run Lighthouse performance audits and Core Web Vitals analysis
allowed-tools:
...
# vibe-test-performance

Run Lighthouse performance audits and Core Web Vitals analysis

## Usage
`/vibe-test-performance [--url] [--device] [--throttling] [--budget]`
